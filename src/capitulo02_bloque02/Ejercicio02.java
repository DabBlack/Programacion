...
public class Ejercicio02 {
	...
	public static void main(String[] args) {
		...
		if (var1 < 0) {
			System.out.println("La aplicacion no admite numeros negativos.");
			return;
		} //Si la varible es negativa se detiene el programa
		...
		int var5 = Integer.parseInt(str); //Se declara la variable var4 de tipo int
		if (var5 < 0) {
			System.out.println("La aplicacion no admite numeros negativos.");
			return;
		} //Si la varible es negativa se detiene el programa
		...
		System.out.println("Numeros bajos: " + bajos + "\nNumeros medios: " + medios + "\nNumeros grandes " + grandes);
